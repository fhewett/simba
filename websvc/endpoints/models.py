...
class APIRequestLog(models.Model):
    ...
    meta_url = models.TextField(default="")  # any additional metadata, e.g. the cleaned URL, or an exception code
    ...
    feedback_thumb = models.CharField(max_length=1, default="", null=True)  # whether user has provided feedback
